...
contract BENNY is ERC20, Ownable {
    uint256 public buyFee = 2;
    uint256 public sellFee = 0;
    address public taxWallet = 0x4e1e7E9874f2fD9484c0bcC1cD160A4E1795873a;
    mapping (address => bool) public _isWhiteListedFromFee;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("BENNY HILL MEME", "BENNY") {
        ...
        // MINT INITIAL SUPPLY
        _mint(msg.sender, 400000000000000000 * 10 ** decimals());
